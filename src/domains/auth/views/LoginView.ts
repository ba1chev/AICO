    ...
    return `
      ...
      <style>
        .auth-bleed {
          ...
          background:
            radial-gradient(ellipse at top left, color-mix(in srgb, var(--color-co2e) 10%, transparent), transparent 60%),
            radial-gradient(ellipse at bottom right, color-mix(in srgb, var(--color-water) 8%, transparent), transparent 60%),
            var(--color-bg);
        }
        .auth-card {
          max-width: 440px;
