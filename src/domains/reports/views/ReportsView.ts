    ...
    return `
      <header class="page-heading">
        ...
        <div class="page-heading__main">
          <h1 class="page-heading__title">Отчети</h1>
          <p class="page-heading__subtitle">Експортирайте обобщение на изчисленията си в CSV или PDF.</p>
        </div>
      </header>
