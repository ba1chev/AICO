...
import type { RecommendationService } from '@domains/calculator/services/RecommendationService';
...
export const TOKENS = {
  ...
  Recommendations: createToken<RecommendationService>('RecommendationService'),
